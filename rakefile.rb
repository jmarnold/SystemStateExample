...
RESULTS_DIR = "results"
PRODUCT = "SystemStateExample"
COPYRIGHT = 'Copyright 2012 SystemStateExample. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/SystemStateExample.sln', :clrversion => CLR_TOOLS_VERSION
